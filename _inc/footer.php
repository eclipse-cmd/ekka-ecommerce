                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-3 ec-footer-contact">
                        <div class="ec-footer-widget">
                            <div class="ec-footer-logo"><a href="#"><img src="<?php echo ROOT ?>/assets/images/logo/footer-logo.png"
                                        alt=""><img class="dark-footer-logo" src="<?php echo ROOT ?>/assets/images/logo/dark-logo.png"
                            ...
                            <div class="ec-footer-links">
                                <ul class="align-items-center">
                                    ...
                                    <li class="ec-footer-link"><span>Call Us:</span><a href="tel:+440123456789">+44
                                            0123 456 789</a></li>
                                    <li class="ec-footer-link"><span>Email:</span><a href="https://loopinfosol.in/cdn-cgi/l/email-protection#32574a535f425e577257511f575f535b5e1c515d5f"><span class="__cf_email__" data-cfemail="48632d30292538242d082d2b652d25292124662b2725">[email&#160;protected]</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col footer-bottom-right">
                        <div class="footer-bottom-payment d-flex justify-content-end">
                            <div class="payment-link">
                                <img src="<?php echo ROOT ?>/assets/images/icons/payment.png" alt="">
                            </div>
